...
**Mitigation verified:** [macOS source smoke run 34046687930](https://github.com/ShikiRyo1/VitalsSight-candidate-aware-rPPG/actions/runs/34046687930), for commit `0b7e43bcd2b4c686b64b958ba41d4c9c44b698a3`, completed successfully. It installed the arm64 0.10.35 wheel, ran the exact source launcher with the pinned Tasks asset, and passed **184 tests** in 37.52 seconds with two dependency warnings. The [Linux public-contract workflow](https://github.com/ShikiRyo1/VitalsSight-candidate-aware-rPPG/actions/runs/34046687907) and [Pages deployment](https://github.com/ShikiRyo1/VitalsSight-candidate-aware-rPPG/actions/runs/34046687885) also passed. This confirms the bounded source-runner regression fix, not all hardware, native packaged-video behavior or clinical validity. No existing macOS Release download was replaced.
